...
words = "аеёиоуыэюя"
syllable = input("Задайте ритм: ").split()

vowels = [sum([True for j in word if j.lower() in words]) for word in syllable]
if all(vowels) and len(set(vowels)) == 1:
    print("Парам пам-пам")
else:
    print("Пам парам")
...
print_operation_table(lambda x, y: x * y, int(input('Введите номер строки: ')), int(input('Введите номер столбца: ')))